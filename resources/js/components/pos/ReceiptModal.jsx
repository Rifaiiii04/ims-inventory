...
function ReceiptModal({ transaction, cart, onClose }) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                ...
                <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-5 border-b border-gray-200 rounded-t-2xl">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-800">Struk Transaksi</h3>
                                <p className="text-sm text-gray-500">Transaksi berhasil diproses</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-semibold">Kasir POS</span>
                            </div>
                            <div className="flex justify-between">
                    ...
                    {/* Items List */}
                    <div>
                        <h4 className="font-bold text-gray-800 mb-3">Daftar Menu</h4>
